    ...
    const initializeAnimation = () => {
      ...
      const sketchProc = function(processingInstance) {
        with (processingInstance) {
          ...
          // Import all the complex classes
          var Cactus = (function() {
          ...
          var Cup = (function() {
            Cup = function(args) {
              ...
              this.steam = [
                { x: 404, y: 335, vy: -0.15, vx: 1.05, opacity: 255, bx: 404, by: 360, diameter: 5 },
                { x: 411, y: 335, vy: -0.12, vx: 1.00, opacity: 255, bx: 411, by: 355, diameter: 4 },
                { x: 419, y: 335, vy: -0.18, vx: 1.10, opacity: 255, bx: 419, by: 360, diameter: 5 }
              ];
              this.teabag = { angle: 0, one: 0, two: 30, three: -15 };
            };
            ...
            Cup.prototype = {
              ...
              update: function() {
                ...
                for(var i = 0; i < this.steam.length; i++) {
                  ...
                  if(this.timer < 240) item.y += item.vy;
                  if(this.timer === 60) {
                    item.opacity = 255;
                    item.x = item.bx;
                    item.y = item.by;
          ...
          var Paper = (function() {
            Paper = function(args) {
              ...
              this.anim = {
                paper: {
                  x: 0, y: 0, angle: 0,
                  one: { x: 183, y: 188, angle: 40 },
                  two: { x: -100, y: 200, angle: 0 },
                  three: { x: 400, y: -100, angle: 0 }
                },
                leg: {
                  x: 195, y: 282,
                  one: { x: 183, y: 188 },
                ...
                arms: {
                  top: {
                    x1: 70, y1: -100, x2: 120, y2: -80, x3: 170, y3: -60, x4: 220, y4: -40,
                    one: { x1: 70, y1: -100, x2: 120, y2: -80, x3: 170, y3: -60, x4: 220, y4: -40 },
                    two: { x1: 70, y1: -20, x2: 80, y2: 50, x3: 90, y3: 90, x4: 110, y4: 125 }
                  },
                  left: {
                    x1: -10, y1: 400, x2: -60, y2: 400, x3: -40, y3: 400, x4: -20, y4: 395,
                    one: { x1: -10, y1: 400, x2: 40, y2: 380, x3: 70, y3: 360, x4: 105, y4: 335 },
                    two: { x1: -20, y1: 400, x2: -20, y2: 380, x3: -20, y3: 360, x4: -20, y4: 265 },
                    three: { x1: -10, y1: 400, x2: -60, y2: 400, x3: -40, y3: 400, x4: -20, y4: 395 }
                  }
                }
              };
            };
          ...
          // Monkey class (simplified version for now)
          var Monkey = (function() {
            Monkey = function(args) {
              ...
              this.anim = {
                ...
                face: { x: 0, y: 0 },
                eyes: { x: 0, y: 0 },
                mouth: { x: 0, diameter: 5 },
                tail: { x1: 433, y1: -10, x2: 443, y2: 120, x3: 392, y3: 60, x4: 400, y4: 177 },
                arms: {
                  right: {
                    x1: 361, y1: 240, x2: 251, y2: 230, x3: 234, y3: 346, x4: 323, y4: 366,
                    one: { x1: 361, y1: 240, x2: 251, y2: 230, x3: 234, y3: 346, x4: 323, y4: 366 },
                    two: { x1: 361, y1: 240, x2: 251, y2: 264, x3: 234, y3: 362, x4: 333, y4: 327 },
                    timer: 0
                  },
                  left: {
                    x1: 435, y1: 307, x2: 492, y2: 375, x3: 504, y3: 445, x4: 437, y4: 504,
                    one: { x1: 435, y1: 307, x2: 492, y2: 375, x3: 504, y3: 445, x4: 437, y4: 504 },
                    two: { x1: 435, y1: 307, x2: 492, y2: 375, x3: 504, y3: 445, x4: 437, y4: 530 },
                    three: { x1: 435, y1: 307, x2: 492, y2: 375, x3: 504, y3: 445, x4: 461, y4: 530 },
                    four: { x1: 435, y1: 307, x2: 512, y2: 345, x3: 544, y3: 425, x4: 585, y4: 490 },
                    timer: 0
                  }
                },
                legs: {
                  right: {
                    x1: 366, y1: 184, x2: 293, y2: 174, x3: 234, y3: 241, x4: 195, y4: 282,
                    one: { x1: 366, y1: 184, x2: 293, y2: 144, x3: 234, y3: 171, x4: 183, y4: 188 },
                    two: { x1: 366, y1: 184, x2: 293, y2: 174, x3: 249, y3: 241, x4: 231, y4: 296 },
                    three: { x1: 366, y1: 184, x2: 293, y2: 174, x3: 234, y3: 241, x4: 195, y4: 282 },
                    timer: 0
                  },
                  left: {
                    x1: 421, y1: 186, x2: 522, y2: 247, x3: 535, y3: 304, x4: 459, y4: 377,
                    one: { x1: 421, y1: 186, x2: 522, y2: 247, x3: 535, y3: 304, x4: 459, y4: 377 },
                    two: { x1: 421, y1: 186, x2: 522, y2: 227, x3: 535, y3: 284, x4: 449, y4: 357 },
                    timer: 0
                  }
                }
              };
          ...
          var App = (function() {
            ...
            App.prototype = {
              ...
              updateKeys: function() {
                if(this.timer > 20 && this.timer < 25) {
